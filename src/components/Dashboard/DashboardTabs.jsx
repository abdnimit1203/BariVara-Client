    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-4">
        <button
          ...
          className={`px-5 py-3 rounded-2xl font-bold text-xs sm:text-sm transition-all duration-300 flex items-center gap-2 shadow-sm ${
            activeTab === "charts"
        ...
        >
          ...
          <span className={`px-2 py-0.5 rounded-full text-xs font-black ${
            activeTab === "table" ? "bg-white/20 text-white" : "bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300"
          }`}>
            {bills.length}
          </span>
        </button>
