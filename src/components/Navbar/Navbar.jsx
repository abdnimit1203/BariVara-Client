    ...
    <div className="drawer text-base-100 font-semibold">
      ...
      <div className="drawer-content flex flex-col">
        ...
        <div className="w-full navbar bg-neutral ">
          ...
          <div className="flex-1 xl:px-2 xl:mx-2 xl:ml-6 w-full lg:ml-0 relative text-black">
            <Link to={"/"} className="mx-auto">
              <img src="/logo.png" alt="BariVara logo" className="w-20 -ml-5" />
            </Link>
            <button onClick={openModal} className="absolute right-4"><FcCalculator className="text-5xl animate-wave" />
            </button>
            <UniversalModal
            isOpen={isModalOpen}
            onClose={closeModal}
