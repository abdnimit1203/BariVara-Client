...
const BarChartMonthly = ({ bills }) => {
  ...
  return (
    <div className="bg-base-100 border border-base-300 p-3 sm:p-6 rounded-2xl shadow-lg mt-4 text-base-content overflow-hidden">
      <h2 className="text-md sm:text-lg font-bold mb-3 bg-base-200 text-base-content p-3 rounded-xl border border-base-300">
        মাসিক বাড়ি ভাড়া লিস্ট (Room-wise)
      </h2>
      ...
      <div className="flex flex-wrap gap-2 my-4">
        <button
          ...
          className={`btn btn-xs sm:btn-sm rounded-xl gap-1.5 border-none transition-all ${
            barType === "total"
